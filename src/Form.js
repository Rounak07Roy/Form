...
const Form = () => {
  ...
  const validate = () => {
    ...
    } else if (!/^\+\d{1,3}\d{10}$/.test(formData.phoneNo)) {
      isValid = false;
      tempErrors["phoneNo"] = "Phone Number is invalid. Format: +countrycode number.";
    }
    if (!formData.country) {
      isValid = false;
    ...
    if (!formData.panNo) {
      ...
      isValid = false;
      tempErrors["panNo"] = "PAN Number is invalid.";
    }
    if (!formData.aadharNo) {
      ...
      isValid = false;
      tempErrors["aadharNo"] = "Aadhar Number is invalid.";
    }
